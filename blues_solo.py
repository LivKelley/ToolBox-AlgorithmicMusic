...
licks = [ [ [1,0.5*1.1], [1,0.5*0.9], [1, 0.5*1.1], [1, 0.5*0.9] ], [ [-1, 0.5*1.1], [-1, 0.5*0.9], [-1, 0.5*1.1], [-1, 0.5*0.9] ], [ [-2, 0.5*0.9], [3, 0.5*0.9], [4, 0.5*1.1], [1, 0.5*0.9] ] ]
for i in range(4):
    lick = choice(licks)
    for note in lick:
        curr_note += note[0]
...
Wavefile.read('Ragtime_Piano_SCOTT_JOPLIN_.wav', backing_track)
